...
def lookup_event_info(question_about_event:str):
    """
    Looks up event information about Nvidia GTC 2024.

    Args:
        question_about_event: question about an event

    Returns:
        An answer about the event information in string form
    """
    ...
    return chain.invoke(question_about_event)

# Example usage
event_info = lookup_event_info("when is the keynote with Jensen?")
# print(event_info) Output: The keynote with Jensen Huang is on Monday, Mar 18 1:00 PM PDT and ends at Monday, Mar 18 3:00 PM PDT. The title of the keynote is "GTC 2024 Keynote [S62542]".
